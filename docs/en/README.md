# Meme Thief · Documentation

> [← Back to project README](../../README_EN.md) · [中文](../README.md)

| Document | What is inside |
|:---|:---|
| [Commands](commands.md) | Every subcommand, plus what the command prefix should actually be |
| [Configuration](configuration.md) | Key settings by group, including the capacity cap that really does delete files |
...
What changed in each release lives in [CHANGELOG.md](../../CHANGELOG.md).
